...
### Cognitive Filtering
This step performs a series of operations, called \textit{filters}, that work on the embeddings coming from the previous step. There are four filters this step derives: density, color, memory, and modulation.
